...
const PipelinePage: React.FC = () => {
  ...
  // Roles allowed to manage boards: only CEO and SALES_MANAGER per requirement
  const BOARD_MANAGE_ROLES = ["CEO", "SALES_MANAGER"];
    ...
    <Box sx={{ px: { xs: 1, sm: 2, md: 3 }, py: { xs: 0.75, sm: 1, md: 1.5 } }}>
      ...
      <Box sx={{ overflowX: "auto", width: "100%" }}>
        <KanbanBoard
          ...
          onAddList={canManageBoards ? () => setAddingStatus(true) : undefined}
