...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const checkAuth = async () => {
    try {
      ...
      console.log("[CRM Auth] URL token:", urlToken ? "Found" : "Not found");
      if (urlToken) {
        console.log("[CRM Auth] Saving token to localStorage");
      ...
      console.log("[CRM Auth] Token from localStorage:", authToken ? "Found" : "Not found");
