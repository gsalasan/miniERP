  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      ...
      <Typography variant='body1' color='text.secondary' sx={{ mb: 4 }}>
        Sistem mengikuti alur bisnis yang disesuaikan dengan kebutuhan
        administrasi dan perpajakan perusahaan.
      </Typography>
          ...
          <Card elevation={2}>
            <CardContent>
              ...
              <Typography variant='body2' color='text.secondary'>
                Data dasar saja, pajak opsional. Fokus pada kontak dan informasi
                dasar pelanggan.
              </Typography>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} md={4}>
          <Card elevation={2}>
            <CardContent>
              ...
              <Typography variant='body2' color='text.secondary'>
                Sudah bertransaksi. Data pajak wajib untuk pembuatan faktur
                resmi.
              </Typography>
            </CardContent>
          </Card>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, bgcolor: 'warning.50' }}>
          ...
          <Alert severity='info' sx={{ mb: 2 }}>
            Field ini menunjukkan sales yang bertanggung jawab terhadap
            pelanggan, namun sistem user belum aktif sepenuhnya.
          </Alert>
