      ...
      <Grid item xs={12}>
        {data.status === 'PROSPECT' && (
          <Alert severity='info' sx={{ mb: 2 }}>
            <Typography variant='body2'>
              <strong>Status Prospect:</strong> Fokus pada data dasar pelanggan.
              Data pajak bersifat opsional dan dapat diisi nanti saat pelanggan
              mulai bertransaksi.
            </Typography>
          </Alert>
        )}
        {data.status === 'ACTIVE' && (
          <Alert severity='warning' sx={{ mb: 2 }}>
            <Typography variant='body2'>
              <strong>Status Active:</strong> Pelanggan sudah bertransaksi. Data
              pajak wajib dilengkapi untuk pembuatan faktur resmi.
            </Typography>
          </Alert>
        )}
      </Grid>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  value={rek.bank_name || ''}
                  onChange={e =>
                    handleRekeningChange(index, 'bank_name', e.target.value)
                  }
                  variant='outlined'
                />
              </Grid>
        ...
        <Grid item xs={12}>
          ...
          >
            <Typography color='text.secondary'>
              Belum ada nomor rekening ditambahkan
            </Typography>
            <Typography color='text.secondary'>
