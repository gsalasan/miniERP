...
const AddOpportunityModal: React.FC<AddOpportunityModalProps> = ({
  ...
  const handleSubmit = async () => {
    try {
      ...
      setError(
        error instanceof Error ? error.message : 'Gagal membuat opportunity'
      );
    }
  };
        ...
        <Grid container spacing={3} sx={{ mt: 1 }}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={e =>
                handleInputChange('estimated_value', Number(e.target.value))
              }
              disabled={loading}
              InputProps={{
                startAdornment: (
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={e =>
                handleInputChange('lead_score', Number(e.target.value))
              }
              disabled={loading}
