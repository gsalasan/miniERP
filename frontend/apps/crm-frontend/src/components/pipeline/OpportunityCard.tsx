        ...
        >
          <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
            ...
            <Box display='flex' alignItems='center' mb={1.5}>
              <BusinessIcon
                fontSize='small'
                sx={{ color: '#666', mr: 0.5, fontSize: '16px' }}
              />
              <Typography
                variant='body2'
            ...
            <Box mb={1.5}>
              ...
              <Box display='flex' alignItems='center' mb={0.5}>
                <MoneyIcon
                  fontSize='small'
                  sx={{ color: '#4CAF50', mr: 0.5, fontSize: '16px' }}
                />
                <Typography
                  variant='body2'
            ...
            >
              <Box display='flex' alignItems='center'>
                <PersonIcon
                  fontSize='small'
                  sx={{ color: '#666', mr: 0.5, fontSize: '14px' }}
                />
                <Typography
                  variant='caption'
                  color='text.secondary'
            ...
            <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
              ...
              <DialogContent>
                <DialogContentText>
                  Anda yakin ingin menghapus opportunity "{project.project_name}"? Tindakan ini tidak dapat dikembalikan.
                </DialogContentText>
              </DialogContent>
              <DialogActions>
