  ...
  const handleDragEnd = useCallback(
    async (result: DropResult) => {
      ...
      newPipeline[sourceStatus] = {
        ...
        totalValue: sourceItems.reduce((sum, p) => sum + toNumber(p.contract_value ?? p.estimated_value ?? 0), 0),
      };
      ...
      newPipeline[destinationStatus] = {
        ...
        totalValue: destinationItems.reduce((sum, p) => sum + toNumber(p.contract_value ?? p.estimated_value ?? 0), 0),
      };
                    ...
                    {(provided, snapshot) => (
                      ...
                      >
                        <KanbanColumn
                          ...
                          onDeleteCard={(projectId: string) =>
                            handleDeleteCard(projectId, status)
                          }
